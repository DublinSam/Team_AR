...
public class ParallaxBackground {
    ...
    */
   public ParallaxBackground(ParallaxLayer[] layers,SpriteBatch spriteBatch,Camera camera,float width,float height,Vector2 speed){
      this.layers = layers;
         ...
         do{
            float currentY = - camera.position.y*layer.parallaxRatio.y % ( height + layer.padding.y) ;
               ...
               batch.draw(layer.region,
                     ...
                     -this.camera.viewportHeight/2 + currentY +layer.startPosition.y,width,height);
